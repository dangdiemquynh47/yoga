      ...
      <div className="">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 mt-10 w-full">
          <input
            ...
            id=""
            placeholder="Name"
            className="border-amber-100 focus:outline-none focus:border-amber-500 border-[0.5px] border-solid py-3 px-5"
          />
          <input
            type="text"
            name=""
        ...
        <div className="w-full">
          <textarea
            ...
            id=""
            placeholder="Message"
            className="resize-none py-3 px-5 h-[154px] w-full mt-6 border-amber-100 focus:outline-none focus:border-amber-500 border-[0.5px] border-solid"
          ></textarea>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-6 text-7xl text-white">
          <div className="group flex items-center justify-center gap-2 py-4 bg-rose-100 w-fit overflow-hidden">
            ...
            <button className="text-orange-500 text-[12px] px-6">SUBMIT</button>
            <div className="h-[1px] w-6 group-hover:translate-x-[14px] duration-300 bg-orange-500"></div>
          </div>
        </div>
      </div>
