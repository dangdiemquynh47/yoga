  ...
  return (
    <div className="w-full">
      <div className="px-14">
        ...
        <div className="grid sm:grid-cols-4 grid-cols-1 gap-8 pt-16">
          {experts.map((item: any, index: number) => {
            return (
              <div className="text-center relative" key={item.img}>
                <div className="group">
                  <div className="">
                    <img
                      ...
                      alt=""
                      className={
                        "w-[300px] object-cover opacity-1 group-hover:opacity-0 duration-300 " +
                ...
                <p className="text-lg italic text-indigo-500">{item.des}</p>
              </div>
            );
          })}
        </div>
