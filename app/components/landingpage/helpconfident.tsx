const HelpConfident = () => {
  ...
  return (
    <div className="w-full px-10 sm:px-[160px] p-[110px] bg-rose-50/50 relative">
      <p className="w-fit text-3xl pb-10">
        Hi! My name is <span className="italic text-indigo-500">Alisia</span>{" "}
        and I’m here to help you find the confidence you need to feel{" "}
      ...
      {/* <div className="border-[1px] border-solid border-amber-500 w-fit px-10 py-3 text-amber-500 text-sm cursor-pointer mt-4">
        <p>READ MORE</p>
      </div> */}
      <div className="mt-4 group flex items-center justify-center gap-2 py-4 w-fit overflow-hidden border-amber-500 border-[1px] border-solid">
        ...
        <button className="text-amber-500 text-[12px] px-4 text-sm">READ MORE</button>
        <div className="h-[1px] w-6 group-hover:translate-x-[14px] duration-300 bg-amber-500"></div>
      </div>
      <img
        src="/images/helpconfident.jpg"
        alt=""
        className="relative sm:absolute sm:top-[110px] sm:right-40 pt-20 sm:pt-0"
      />
    </div>
  );
};
